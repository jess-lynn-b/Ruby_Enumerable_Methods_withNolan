...
# Each Method
  # Calling 'each' on an array will iterate through that array and will yield each element to a code block, where a task can be preformed 
attendees = ['donald', 'dasiy', 'mickey', 'minnie', 'goofy', 'max']
...
# Map Method
  #The 'map' method (also called 'collect') transforms each element from an array according to whtever block you pass to it and returns the transformed elements in a new array.
...
puts attendees.select { |attendee| attendee != 'mickey'}
